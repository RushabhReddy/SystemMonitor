...
float Process::CpuUtilization() const {
    float utilization = ((static_cast<float>(LinuxParser::ActiveJiffies(Process::Pid()))  / static_cast<float>(sysconf(_SC_CLK_TCK))) / static_cast<float>(LinuxParser::UpTime(Process::Pid())));
    return utilization;
}
